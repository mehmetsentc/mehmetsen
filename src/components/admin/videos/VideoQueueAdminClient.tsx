...
import { Video, Eye, CheckCircle2, XCircle, Play } from 'lucide-react'
...
export function VideoQueueAdminClient({ libraryEnabled = false }: { libraryEnabled?: boolean }) {
  ...
  return (
    <div className="flex flex-col">
      <CMSHeader
        title={libraryEnabled ? 'AI Video Kuyruğu' : 'Video Yönetimi'}
        subtitle="Mevcut AI script / TTS kuyruğu (Firestore videoQueue)"
      />
