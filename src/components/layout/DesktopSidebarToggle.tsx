...
export function DesktopSidebarToggle() {
  ...
  return (
    <button
      ...
      className="back-nav-sidebar-toggle fixed left-[3.75rem] top-4 z-[150] hidden h-10 w-10 items-center justify-center rounded-xl border border-[rgb(var(--color-border))] bg-[rgb(var(--color-surface))] text-[rgb(var(--color-text))] shadow-sm transition-colors hover:bg-[rgb(var(--bg-subtle))] lg:flex"
    >
