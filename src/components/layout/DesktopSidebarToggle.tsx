...
export function DesktopSidebarToggle() {
  ...
  return (
    <button
      ...
      className="fixed left-4 top-4 z-[150] hidden h-10 w-10 items-center justify-center rounded-xl border border-[rgb(var(--color-border))] bg-[rgb(var(--color-card))] text-[rgb(var(--color-text))] shadow-sm transition-colors hover:bg-[rgb(var(--color-surface))] lg:flex"
    >
