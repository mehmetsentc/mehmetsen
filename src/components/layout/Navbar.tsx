...
export function Navbar({ onMenuClick }: NavbarProps = {}) {
  ...
  // Use --header-onbrand (ink on newspaper paper, white on navy) — never hardcode
  // text-white or icons vanish in light/newspaper chrome.
  const iconIdle =
  ...
  const iconActive =
    'relative flex h-12 w-12 shrink-0 items-center justify-center touch-manipulation rounded-full bg-transparent text-[rgb(var(--brand-500))] transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgb(var(--header-onbrand))]/50'
