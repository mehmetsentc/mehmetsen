 ...
 *
 * V5: RIGHT-return product authority re-teach (v4 docs/key still said LEFT).
 */

export const READER_RETURN_COACH_STORAGE_KEY = 'nahaber.readerReturnCoach.v5'
...
export function markReaderReturnCoachLearned(): void {
  ...
  writeReaderReturnCoachState({ learned: true, shownCount: cur.shownCount, version: 5 })
}

export function resetReaderReturnCoachPresentation(): void {
  writeReaderReturnCoachState({ learned: false, shownCount: 0, version: 5 })
}
