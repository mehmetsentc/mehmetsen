...
const SEED_CATEGORIES = [
  ...
  { id: 'kibris-asayis', name: 'Kıbrıs Asayiş', slug: 'kibris-asayis', parentId: 'kibris-haberleri', iconName: 'shield-alert', color: '#0E7490', isStandalone: false },
  { id: 'kibris-gundem', name: 'Kıbrıs Gündem', slug: 'kibris-gundem', parentId: 'kibris-haberleri', iconName: 'newspaper', color: '#0E7490', isStandalone: false },
  { id: 'kibris-siyaset', name: 'Kıbrıs Siyaset', slug: 'kibris-siyaset', parentId: 'kibris-haberleri', iconName: 'landmark', color: '#0E7490', isStandalone: false },
  { id: 'kibris-spor', name: 'Kıbrıs Spor', slug: 'kibris-spor', parentId: 'kibris-haberleri', iconName: 'trophy', color: '#0E7490', isStandalone: false },
  { id: 'kibris-futbol', name: 'Kıbrıs Futbol', slug: 'kibris-futbol', parentId: 'kibris-haberleri', iconName: 'circle-dot', color: '#0E7490', isStandalone: false },
  { id: 'kibris-basketbol', name: 'Kıbrıs Basketbol', slug: 'kibris-basketbol', parentId: 'kibris-haberleri', iconName: 'circle', color: '#0E7490', isStandalone: false },
  { id: 'kibris-voleybol', name: 'Kıbrıs Voleybol', slug: 'kibris-voleybol', parentId: 'kibris-haberleri', iconName: 'circle', color: '#0E7490', isStandalone: false },
  { id: 'kibris-hentbol', name: 'Kıbrıs Hentbol', slug: 'kibris-hentbol', parentId: 'kibris-haberleri', iconName: 'circle', color: '#0E7490', isStandalone: false },
  { id: 'kibris-atletizm', name: 'Kıbrıs Atletizm', slug: 'kibris-atletizm', parentId: 'kibris-haberleri', iconName: 'zap', color: '#0E7490', isStandalone: false },
  { id: 'kibris-gures', name: 'Kıbrıs Güreş', slug: 'kibris-gures', parentId: 'kibris-haberleri', iconName: 'swords', color: '#0E7490', isStandalone: false },
  { id: 'kibris-tenis', name: 'Kıbrıs Tenis', slug: 'kibris-tenis', parentId: 'kibris-haberleri', iconName: 'circle', color: '#0E7490', isStandalone: false },
  { id: 'kibris-yuzme', name: 'Kıbrıs Yüzme', slug: 'kibris-yuzme', parentId: 'kibris-haberleri', iconName: 'waves', color: '#0E7490', isStandalone: false },
  { id: 'kibris-motor-sporlari', name: 'Kıbrıs Motor Sporları', slug: 'kibris-motor-sporlari', parentId: 'kibris-haberleri', iconName: 'gauge', color: '#0E7490', isStandalone: false },
  { id: 'kibris-etkinlik', name: 'Kıbrıs Etkinlik', slug: 'kibris-etkinlik', parentId: 'kibris-haberleri', iconName: 'calendar', color: '#0E7490', isStandalone: false },
  { id: 'kibris-sinema', name: 'Kıbrıs Sinema', slug: 'kibris-sinema', parentId: 'kibris-haberleri', iconName: 'film', color: '#0E7490', isStandalone: false },
  { id: 'kibris-kultur', name: 'Kıbrıs Kültür', slug: 'kibris-kultur', parentId: 'kibris-haberleri', iconName: 'palette', color: '#0E7490', isStandalone: false },
  { id: 'kibris-konser', name: 'Kıbrıs Konser', slug: 'kibris-konser', parentId: 'kibris-haberleri', iconName: 'music', color: '#0E7490', isStandalone: false },
  { id: 'kibris-magazin', name: 'Kıbrıs Magazin', slug: 'kibris-magazin', parentId: 'kibris-haberleri', iconName: 'star', color: '#0E7490', isStandalone: false },
  { id: 'kibris-saglik', name: 'Kıbrıs Sağlık', slug: 'kibris-saglik', parentId: 'kibris-haberleri', iconName: 'heart', color: '#0E7490', isStandalone: false },
  { id: 'kibris-yasam', name: 'Kıbrıs Yaşam', slug: 'kibris-yasam', parentId: 'kibris-haberleri', iconName: 'leaf', color: '#0E7490', isStandalone: false },
  { id: 'kibris-gezi', name: 'Kıbrıs Gezi', slug: 'kibris-gezi', parentId: 'kibris-haberleri', iconName: 'map', color: '#0E7490', isStandalone: false },
  { id: 'kibris-egitim', name: 'Kıbrıs Eğitim', slug: 'kibris-egitim', parentId: 'kibris-haberleri', iconName: 'graduation-cap', color: '#0E7490', isStandalone: false },
  { id: 'kibris-finans', name: 'Kıbrıs Finans', slug: 'kibris-finans', parentId: 'kibris-haberleri', iconName: 'chart-line', color: '#0E7490', isStandalone: false },
  { id: 'kibris-kariyer', name: 'Kıbrıs Kariyer', slug: 'kibris-kariyer', parentId: 'kibris-haberleri', iconName: 'briefcase', color: '#0E7490', isStandalone: false },
  { id: 'kibris-ekonomi', name: 'Kıbrıs Ekonomi', slug: 'kibris-ekonomi', parentId: 'kibris-haberleri', iconName: 'trending-up', color: '#0E7490', isStandalone: false },
  { id: 'kibris-emlak', name: 'Kıbrıs Emlak', slug: 'kibris-emlak', parentId: 'kibris-haberleri', iconName: 'building-2', color: '#0E7490', isStandalone: false },
  { id: 'kibris-enerji', name: 'Kıbrıs Enerji', slug: 'kibris-enerji', parentId: 'kibris-haberleri', iconName: 'bolt', color: '#0E7490', isStandalone: false },
  { id: 'kibris-teknoloji', name: 'Kıbrıs Teknoloji', slug: 'kibris-teknoloji', parentId: 'kibris-haberleri', iconName: 'cpu', color: '#0E7490', isStandalone: false },
  { id: 'kibris-bilim', name: 'Kıbrıs Bilim', slug: 'kibris-bilim', parentId: 'kibris-haberleri', iconName: 'flask', color: '#0E7490', isStandalone: false },
  { id: 'kibris-cevre-iklim', name: 'Kıbrıs Çevre & İklim', slug: 'kibris-cevre-iklim', parentId: 'kibris-haberleri', iconName: 'tree-pine', color: '#0E7490', isStandalone: false },
  { id: 'kibris-oyun-espor', name: 'Kıbrıs Oyun & Espor', slug: 'kibris-oyun-espor', parentId: 'kibris-haberleri', iconName: 'gamepad-2', color: '#0E7490', isStandalone: false },
  { id: 'kibris-din-inanc', name: 'Kıbrıs Din & İnanç', slug: 'kibris-din-inanc', parentId: 'kibris-haberleri', iconName: 'moon-star', color: '#0E7490', isStandalone: false },
  { id: 'kibris-tiyatro', name: 'Kıbrıs Tiyatro', slug: 'kibris-tiyatro', parentId: 'kibris-haberleri', iconName: 'theater', color: '#0E7490', isStandalone: false },
  { id: 'kibris-festival', name: 'Kıbrıs Festival', slug: 'kibris-festival', parentId: 'kibris-haberleri', iconName: 'party-popper', color: '#0E7490', isStandalone: false },
  { id: 'kibris-gastronomi', name: 'Kıbrıs Gastronomi', slug: 'kibris-gastronomi', parentId: 'kibris-haberleri', iconName: 'utensils', color: '#0E7490', isStandalone: false },
  { id: 'kibris-otomobil', name: 'Kıbrıs Otomobil', slug: 'kibris-otomobil', parentId: 'kibris-haberleri', iconName: 'car', color: '#0E7490', isStandalone: false },
  { id: 'kibris-meteoroloji', name: 'Kıbrıs Meteoroloji', slug: 'kibris-meteoroloji', parentId: 'kibris-haberleri', iconName: 'cloud-rain', color: '#0E7490', isStandalone: false },
  { id: 'kibris-turizm', name: 'Kıbrıs Turizm', slug: 'kibris-turizm', parentId: 'kibris-haberleri', iconName: 'plane', color: '#0E7490', isStandalone: false },
  { id: 'kibris-tarih', name: 'Kıbrıs Tarih', slug: 'kibris-tarih', parentId: 'kibris-haberleri', iconName: 'book-open', color: '#0E7490', isStandalone: false },
  { id: 'kibris-duyuru', name: 'Kıbrıs Duyuru', slug: 'kibris-duyuru', parentId: 'kibris-haberleri', iconName: 'megaphone', color: '#0E7490', isStandalone: false },
  ...
  { id: 'influencer', name: 'Influencer', slug: 'influencer', parentId: 'magazin', iconName: 'star', color: '#F472B6', isStandalone: false },
  ...
  { id: 'muzik', name: 'Müzik', slug: 'muzik', parentId: null, iconName: 'music-2', color: '#D946EF', isStandalone: false },
  { id: 'konser', name: 'Konser', slug: 'konser', parentId: 'muzik', iconName: 'music', color: '#8B5CF6', isStandalone: false },
  { id: 'sanatci-haberleri', name: 'Sanatçı Haberleri', slug: 'sanatci-haberleri', parentId: 'muzik', iconName: 'mic-2', color: '#D946EF', isStandalone: false },
  { id: 'kultur', name: 'Kültür & Sanat', slug: 'kultur', parentId: null, iconName: 'palette', color: '#8B5CF6', isStandalone: false },
  { id: 'sinema', name: 'Sinema', slug: 'sinema', parentId: 'kultur', iconName: 'film', color: '#8B5CF6', isStandalone: false },
  { id: 'dizi-tv', name: 'Dizi & TV', slug: 'dizi-tv', parentId: 'kultur', iconName: 'tv', color: '#8B5CF6', isStandalone: false },
  ...
  { id: 'moda', name: 'Moda & Güzellik', slug: 'moda', parentId: 'yasam', iconName: 'shirt', color: '#DB2777', isStandalone: false },
  { id: 'anne-cocuk', name: 'Anne & Çocuk', slug: 'anne-cocuk', parentId: 'yasam', iconName: 'baby', color: '#E879F9', isStandalone: false },
  { id: 'dekorasyon', name: 'Ev & Yaşam', slug: 'dekorasyon', parentId: 'yasam', iconName: 'sofa', color: '#C2410C', isStandalone: false },
  { id: 'iliskiler', name: 'Aile & İlişkiler', slug: 'iliskiler', parentId: 'yasam', iconName: 'heart-handshake', color: '#E11D48', isStandalone: false },
