...
export const CATEGORY_RULES: CategoryRule[] = [
...

  {
    ...
    include: [
      ...
      'Sosyal olaylar, sivil toplum, çevre',
      'Turizm, eğitim, sağlık sistemi haberleri (uzmanlık gerektirmeyen)',
      'Belediye haberleri (ulusal kapsama sahip olanlar)',
    ],
    exclude: [
      'Net siyasi içerik → siyaset',
      'Ekonomi/borsa/faiz → ekonomi',
...

  {
    ...
    include: [
      ...
      'Moda, güzellik haberleri (ürün tanıtım değil)',
    ],
    exclude: [
...

  {
    ...
    include: [
      ...
      'İklim değişikliği, çevre bilimi',
