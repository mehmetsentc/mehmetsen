...
function validateBreaking(
  ...
  const NON_BREAKING_TRIGGERS = [
    ...
    { pattern: /belediye.*park|belediye.*yol|belediye.*hizmet|belediye.*asfalt|belediye.*çalışma|belediye.*düzenleme|belediye.*tamir|belediye.*bakım/, reason: 'belediye hizmet haberi' },
    { pattern: /belediye başkanı.*ziyaret|belediye başkanı.*açıkladı|belediye başkanı.*dedi|belediye başkanı.*inceledi|belediye başkanı.*katıldı|belediye başkanı.*incelemelerde/, reason: 'belediye başkanı ziyaret/inceleme haberi' },
    { pattern: /asfalt serim|asfalt çalışma|yol onarım|kaldırım çalışma|mahalle.*düzenleme|cadde.*çalışma|sokak.*onarım/, reason: 'yerel altyapı çalışması' },
    { pattern: /ilçede.*inceleme|mahallede.*inceleme|beldede.*inceleme|semtte.*inceleme|bölgede.*inceleme.*başkan/, reason: 'yerel inceleme haberi' },
