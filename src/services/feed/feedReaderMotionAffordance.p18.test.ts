...
describe('tappable LEFT/RIGHT affordances', () => {
  it('LEFT affordance is a button hit target; learns on swipe or affordance', () => {
  ...
  it('RIGHT affordance taps beginClose(gesture); Back Arrow does not mark learned alone', () => {
