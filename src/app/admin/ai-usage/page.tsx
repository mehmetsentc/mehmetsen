    ...
    >
      ...
      <AdminOsMetricGrid
        items={[
          ...
          { label: 'Crawler otomatik AI', value: loading ? '…' : fmtUsd(data?.automaticAiCost?.crawlerUsd ?? 0), hint: 'Telemetry — fake estimate yok', tone: 'ok' },
          { label: 'Legacy otomatik AI', value: loading ? '…' : fmtUsd(data?.automaticAiCost?.legacyUsd ?? 0), hint: 'Telemetry — fake estimate yok', tone: 'ok' },
          { label: 'Manuel editör AI', value: loading ? '…' : fmtUsd(data?.automaticAiCost?.manualEditorUsd ?? 0) },
