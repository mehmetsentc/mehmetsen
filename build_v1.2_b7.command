...
# ============================================================
# NaHaber v1.2 Build 7 — Build & Upload
# Düzeltmeler:
#   - Guideline 5.1.1: Konum izni "Sonra" + X butonu kaldırıldı
#   - Guideline 2.1(a): Apple Sign In main thread fix (iPad)
# ============================================================

PROJECT_DIR="/Users/user/nahaber"
IOS_DIR="$PROJECT_DIR/ios/App"
ARCHIVE_PATH="/Users/user/Downloads/NaHaber_1.2_b7.xcarchive"
EXPORT_DIR="/Users/user/Downloads/NaHaber_IPA_b7"
...
LOG="/Users/user/Downloads/build_upload_b7.log"

echo "============================================================" | tee "$LOG"
echo "NaHaber v1.2 Build 7 — Build & Upload" | tee -a "$LOG"
...
# --- xcodebuild archive (Build 7) ---
echo "" | tee -a "$LOG"
echo "=== Xcode Archive (v1.2 Build 7) ===" | tee -a "$LOG"
rm -rf "$ARCHIVE_PATH"
cd "$IOS_DIR"
xcodebuild archive \
...
echo "" | tee -a "$LOG"
echo "=== App Store Connect Upload (Build 7) ===" | tee -a "$LOG"
...
echo "" | tee -a "$LOG"
echo "============================================================" | tee -a "$LOG"
echo "✅ TÜM İŞLEMLER TAMAMLANDI — v1.2 Build 7" | tee -a "$LOG"
echo "Log: $LOG" | tee -a "$LOG"
echo "============================================================" | tee -a "$LOG"
echo ""
echo "Sonraki adım — App Store Connect'te:"
echo "1. Build 7 TestFlight'ta işlenince (~15dk) version sayfasına ekle"
echo "2. Export Compliance: No → Save"
